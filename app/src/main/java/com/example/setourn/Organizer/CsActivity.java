...
public class CsActivity extends AppCompatActivity {
    ...
    public static final String TAG = "CSACT";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TypeRadioGroup = findViewById(R.id.cs_tournament_type_radio);
        ParticipantsRadioGroup = findViewById(R.id.cs_participants_radio);
        OpenTillRadioGroup = findViewById(R.id.cs_open_till);
        Button setTournamentButton = findViewById(R.id.set_tournament_submit_for_cs);
        ...
        setTournamentButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(TypeSelected == -1 || ParticipantsSelected == -1 || OpenTillSelected == -1){
                    Toast.makeText(CsActivity.this, "Please Select All Options", Toast.LENGTH_SHORT).show();
                }else{
                    ...
                    LiveTournaments liveTournaments = new LiveTournaments(TypeRadioButton.getText().toString(),ParticipantsRadioButton.getText().toString(),username,"Cs",date,time,OpenTillRadioButton.getText().toString(),null,"Registration",null,timeMilli,null);
                    ...
                    ref.add(liveTournaments).addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                        ...
                        public void onSuccess(DocumentReference documentReference) {
                            ...
                            Toast.makeText(CsActivity.this,"Tournament Live Now!",Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(CsActivity.this, OrganizerHomePage.class);
